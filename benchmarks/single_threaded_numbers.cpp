/**
 * @file                single_threaded_numbers.cpp
 * @author              Aditya Agarwal (aditya.agarwal@dumblebots.com)
 * @brief               Program to run benchmarks using numbers on a single thread
 *
 ...
 *
 * Example: single_threaded_numbers ../random_all.in 50000 1000000
 */
...
run_benchmark (int pN)
{
    ...
    // int64_t                             insTimeMax1      {0ULL};

    // int64_t                             insTimeTotal2    {0ULL};
    // int64_t                             insTimeMin2      {0ULL};
    // int64_t                             insTimeMax2      {0ULL};

    // int64_t                             findTimeTotal1   {0ULL};
    // int64_t                             findTimeMin1     {0ULL};
    // int64_t                             findTimeMax1     {0ULL};

    // int64_t                             findTimeTotal2   {0ULL};
    // int64_t                             findTimeMin2     {0ULL};
    // int64_t                             findTimeMax2     {0ULL};

    // int64_t                             delTimeTotal1    {0ULL};
    // int64_t                             delTimeMin1      {0ULL};
    // int64_t                             delTimeMax1      {0ULL};

    // int64_t                             delTimeTotal2    {0ULL};
    // int64_t                             delTimeMin2      {0ULL};
    // int64_t                             delTimeMax2      {0ULL};
